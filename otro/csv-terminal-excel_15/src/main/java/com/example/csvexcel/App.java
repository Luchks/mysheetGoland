        ...
        while (true) {
            ...
            for (int i = topRow; i < Math.min(topRow + viewHeight, sheet.getRowCount()); i++) {
                ...
                for (int j = leftCol; j < Math.min(leftCol + viewWidth, sheet.getColCount()); j++) {
                    ...
                    String reset = "\033[0m";
                    String bgBlue = "\033[44m";   // activa
                    String bgGray = "\033[100m";  // columna vacía
                    String bgLight = "\033[47m";  // celda vacía individual (opcional contraste)
                    ...
                    if (i == curRow && j == curCol) {
                        System.out.print(bgBlue + val + reset + "\t");
                    } else if (markLabel != null) {
                        String bgYellow = "\033[43m";
                        // Muestra la letra de la marca entre corchetes
                        System.out.print(bgYellow + "[" + markLabel + "]" + val + reset + "\t");
                    } else if (colVacia) {
                        System.out.print(bgGray + (val.isEmpty() ? " " : val) + reset + "\t");
                    } else if (val.trim().isEmpty()) {
                        System.out.print(bgLight + " " + reset + "\t");
                    } else {
            ...
            // Encabezado de columnas tipo Excel
            System.out.println("--------------------------------------------------------------------------------------");
            System.out.print("\t"); // espacio para la numeración de filas si quieres
            for (int j = leftCol; j < Math.min(leftCol + viewWidth, sheet.getColCount()); j++) {
                System.out.print(sheet.getColumnName(j) + "\t");
            }
            System.out.println();
            System.out.println("--------------------------------------------------------------------------------------");
